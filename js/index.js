const contractAddress="ct_PM6awj99smYX7f8DBqNgaWUfPcH7Ec1KPDDyRX5tETjdKnCvC" ;
...
function createNewMeme(i){
    ...
    voteButton.addEventListener('click', async function(){
        ...
        if(aeInput.value==""){
          ...
          console.log(myArr[i][0]);
          document.getElementById("loader").style.display="block";
          await  contractCall("voteMeme",[import moduleName from 'module'],parseInt(aeInput.value));
          document.getElementById("loader").style.display="none";
          myArr[i][1]['voteCount']=myArr[i][1]['voteCount']+parseInt(aeInput.value);
          voteCountParagraph.innerText='Votecount :'+ myArr[i][1]['voteCount']
